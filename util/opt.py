...
_parser.add_argument('--host-file', metavar='filename', type=str, dest='host_file',
                     help='host filename, default host.txt', default='host.txt')
...
_parser.add_argument('--remote-host', metavar='host', type=str,
                     dest='remote_host', help='remote DNS server', required=True)
